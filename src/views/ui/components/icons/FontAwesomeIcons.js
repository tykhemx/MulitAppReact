  ...
  render() {
    return (
      <div id="content">
        <div className="row">
          <BigBreadcrumbs
            items={["UI Elements", "Icons", "Font Awesome"]}
                ...
                <div>
                  ...
                  >
                    <div className="alert alert-info">
                      <i className="fa fa-exclamation" /> Please note: As of the
                      of Font Awesome version 4.0. All icons now require a base
                      class of <code>fa</code> as well as individual icon
                      classes. For example <code> fa fa-adjust</code>
                      <br />
                      <div className="margin-top-5">
                        View the full icon list by going to{" "}
                        <a
                    ...
                    <div className="alert alert-warning">
                      <strong>NOTE</strong>: FontAwesome version 4.2 is blurry
                      on some resolutions, therefore we did not upgrade (the
                      included FontAwesome version is 4.1). Hopefully this issue
                      will be resolved in later versions of FontAwesome and will
                      be safer to upgrade
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
                        <i className="fa fa-ellipsis-horizontal" />{" "}
                      ...
                      <div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
                        <i className="fa fa-resize-horizontal" />{" "}
                        fa-resize-horizontal
                      </div>
                      <div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
                        <i className="fa fa-resize-vertical" />{" "}
                        fa-resize-vertical
                      </div>
                      <div className="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
