...
export default class FormElements extends React.Component {
                ...
                <div>
                  ...
                  <div className="widget-body no-padding">
                    <form className="smart-form">
                      ...
                      <fieldset>
                        <section>
                          <label className="label" style={{ fontSize: "20px", fontWeight: "bold" }}>
                            Niveles del Negocio
                          </label>
                          <br/>
                          ...
                          <div className="rating">
                            ...
                            <span style={{ fontSize: "17px", fontWeight: "bold" }}> Tykhé </span> <span style={{ fontSize: "11px" }}>- Diosa de la Abundandcia</span>
                          </div>
  ...
  <div className="rating">
	...
	<span style={{ fontSize: "17px", fontWeight: "bold" }}> Atenéa </span> <span style={{ fontSize: "11px" }}>- Diosa de la Sabiduría</span>
  </div>
  ...
  <div className="rating">
	...
	<span style={{ fontSize: "17px", fontWeight: "bold" }}> Afrodita </span> <span style={{ fontSize: "11px" }}>- Diosa de la Belleza</span>
  </div>
  ...
  <div className="rating">
	...
	<label htmlFor="stars-rating-1" >
	 ...
	 <span style={{ fontSize: "17px", fontWeight: "bold" }}> Hestia </span> <span style={{ fontSize: "11px" }}>- Diosa del Hogar</span>
  </div>
 ...
 <span style={{ fontSize: "17px", fontWeight: "bold" }}> 	Deméter </span> <span style={{ fontSize: "11px" }}>- Diosa de la Agricultura</span>
  </div>
   ...
   <div className="rating">
	...
	<span style={{ fontSize: "17px", fontWeight: "bold" }}> Eos </span> <span style={{ fontSize: "11px" }}>- Diosa del Amanecer</span>
  </div>
