      ...
      <div>
        <div id="left">
          ...
          <p>
            ...
            rise to legal action whether against you or [NAME] or a third party
          ...
          <p>
            [NAME] reserves the right to edit or remove any material submitted
            to this website, or stored on [NAME'S] servers, or hosted or
          ...
          <p>
            [NAME] will not be liable to you (whether under the law of contact,
          ...
          <p>
            ...
            [NAME'S] liability in respect of any:
          </p>
          <ul>
          ...
          <p>
            ...
            [NAME] to a third party in settlement of a claim or dispute on the
            advice of [NAME'S] legal advisers) incurred or suffered by [NAME]
          ...
          <p>
            ...
            [NAME] may take such action as [NAME] deems appropriate to deal with
          ...
          <h2>Assignment</h2>
          <p>
            [NAME] may transfer, sub-contract or otherwise deal with [NAME'S]
          ...
          <p>
            ...
            the entire agreement between you and [NAME] in relation to your use
            of this website, and supersede all previous agreements in respect of
          ...
          <p>
            ...
            and available at{" "}
            <a href="http://www.SmartAdmin.com">www.SmartAdmin.com</a>.
            Contractology supply a wide variety of commercial legal documents,
            such as{" "}
            <a href="#/" onClick={this.onClick}>template data protection statements</a>.
          </p>
        ...
        <p>
          <strong>
            By using this WEBSITE TERMS AND CONDITIONS template document, you
            agree to the
            <a href="#/" onClick={this.onClick}>terms and conditions</a> set out on
            <a href="#/" onClick={this.onClick}>SmartAdmin.com</a>. You must retain the
            credit set out in the section headed "ABOUT THESE WEBSITE TERMS AND
            CONDITIONS". Subject to the licensing restrictions, you should edit
            the document, adapting it to the requirements of your jurisdiction,
            your business and your website. If you are not a lawyer, we
            recommend that you take professional legal advice in relation to the
            editing and use of the template.
          </strong>
        </p>
      </div>
    );
